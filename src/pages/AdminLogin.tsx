...
const AdminLogin: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 ${
      darkMode ? 'bg-gray-900' : 'bg-gradient-to-br from-red-50 via-white to-pink-50'
    }`}>
      <div className="max-w-md w-full space-y-8">
        ...
        >
          <div className="w-16 h-16 mx-auto bg-gradient-to-r from-red-500 to-pink-600 rounded-full flex items-center justify-center mb-6">
            <Shield className="w-8 h-8 text-white" />
          </div>
          <h2 className={`text-3xl font-bold mb-2 ${darkMode ? 'text-white' : 'text-gray-900'}`}>
            Admin Login
          </h2>
          <p className={darkMode ? 'text-gray-300' : 'text-gray-600'}>Access the administrative dashboard</p>
        </motion.div>
        ...
        >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@mentorconnect.edu"
                />
              </div>
            </div>
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-red-500 to-pink-600 text-white py-3 px-4 rounded-lg font-medium hover:from-red-600 hover:to-pink-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
          >
            Sign In as Admin
          </button>
        </motion.form>
